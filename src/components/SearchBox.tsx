...
export default function SearchBox() {
  ...
  const { setTarget, setSetupStep } = useNavStore(); // ไม่เรียก setFloor ตรงนี้แล้ว
  ...
  const handleSelect = (loc: any) => {
    ...
    setTarget(loc); // 1. จำเป้าหมายปลายทางไว้
    setSetupStep('floor'); // 2. ✅ เปิดหน้าต่างถามว่าผู้ใช้อยู่ชั้นไหน
  };
